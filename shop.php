<?php 
	...
	if($my_shop['shop_message']!="")
	{
		echo "<script> alert('Your subscription period is almost over! Please renew!'); </script>";
	}
	...
	<div class="container">
		<div class="row mid">
			...
			<div class="col-md-7 lf">
				...
				<div class="pa">
					...
					<p> Phone: <?php echo $my_shop['shop_phone']; ?></p>
					<p> Shop Area: <?php echo $my_shop['shop_area']; ?></p><br>    
					<button class="btn btn-success" type="button" onclick="window.location.href='edit_shop.php?id=<?php echo $my_shop['shop_id']; ?>'">EDIT SHOP</button>
				</div>
			</div>
		</div>
		<!-- offers-->
		...
		<?php foreach ($products as $row) { ?>
			...
			<div class="col-md-2 list">
				...
				<div class="act">
					<button class="btn btn-success" onclick="window.location.href='single_product.php?id=<?php echo $row['product_id']; ?>'">Details</button>
					<button class="btn btn-danger" onclick="window.location.href='delete_product.php?id=<?php echo $row['product_id']; ?>'">Delete</button>
				</div>
			</div>
			<?php } ?>	
		</div>
