<?php 
	...
	if(isset($_POST['change']))
	{
	    ...
	    $doc=$user->editImageUser($id,$user_pic);
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">User Profile Edit Page</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
<!-- login -->
	<div class="container mid">
		<div class="col-md-6">
			<img src="user_images/<?php if($my_user['user_image'] != NULL) 
			{
				echo $my_user['user_image'];
			}
			else
			{
				if($my_user['user_sex']=="Male")
				{
		...
		<div class="col-md-6">
			<form method="POST" action="edit_user_profile_info.php">
			  <div class="form-group">
			    <label for="exampleInputEmail1">Name</label>
			    <input type="text" class="form-control" name="user_name" id="exampleInputPassword1" value="<?php echo $my_user['user_name']; ?>">
			    
			  </div>
			  <div class="form-group">
			    <label for="exampleInputPassword1">City</label>
			    <select class="form-control" name="user_city[]" placeholder="Enter city">
						<option><?php echo $my_user['user_city']; ?></option>
						<option>Dhaka</option>
			  ...
			  <div class="form-group">
			    ...
			    <select class="form-control" name="user_sex[]" placeholder="Enter city">
						<option><?php echo $my_user['user_sex']; ?></option>
						<option>Male</option>
			  ...
			  <div class="form-group">
			    ...
			    <input type="number" class="form-control" name="user_age" id="exampleInputPassword1" value="<?php echo $my_user['user_age']; ?>">
			    
			  </div>

			  <div class="form-group">
			    <label for="exampleInputEmail1">Address</label>
			    <textarea rows="2" class="form-control" name="user_address"><?php echo $my_user['user_address']; ?></textarea>
