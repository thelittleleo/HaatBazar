<?php 
	...
	//s$add_customer_id = $_SESSION['id'];
	
	$offer = $user->getAddsAdmin();
	//var_dump($offer);
...
<!-- breadcrumbs -->
	<div class="container" style="margin-top: 2%">
		<h3 class="text-center" style="margin-bottom: 2%"> Add List </h3>
		<?php 
			if($offer)
			{
			...
			<table class="table">
			  ...
			  <tbody>
			    ...
			    <tr class="text-center">
					...
					<td class="text-center"> <button type="button" class="btn btn-warning" onclick="window.location.href='delete_add_admin.php?id=<?php echo $row['add_request_id']; ?>'">Delete</button></td>
					</tr>
