<?php 
	...
	$offer = $user->getAddRequestsAdmin();
	//var_dump($offer);
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Add Requests Page</li>
			</ol>
		</div>
	</div>
<!-- //navigation -->
<!-- breadcrumbs -->
	<div class="container" style="margin-top: 2%">
		<h3 class="text-center" style="margin-bottom: 2%"> Add Requests List </h3>
		<?php 
			if($offer)
			{
			...
			<table class="table">
			  ...
			  <tbody>
			    ...
			    <tr class="text-center">
					...
					<td class="text-center"> <button type="button" class="btn btn-success" onclick="window.location.href='accept_request_add.php?id=<?php echo $row['add_request_id']; ?>'">Accept</button>  <button type="button" class="btn btn-warning" onclick="window.location.href='delete_add_admin.php?id=<?php echo $row['add_request_id']; ?>'">Delete</button></td>
					</tr>
